        ...
        return (
          <div className="card">
            ...
            <div className="card-footer">
              ...
              <p>{posts.body}</p>
              <h5 style={{fontSize:"bold",cursor:"pointer"}} onClick={()=>{
                toggleComment(posts);
              }} >View all comments</h5>
            </div>
      ...
      <div className="show-comment"  >
        <div className="container">
          ...
          <div className="detail">
            <div className="card-header" style={{borderBottom:"1px solid rgb(148 165 86) "}}>
            ...
            <div className="allcomment">
              ...
              return(<p className="comm" style={{color:"#d5FF40"}}>
                <span className="commenter" style={{fontWeight:"bolder"}}>{comment.postedBy.name}{" "}</span>
                <span className="commentText">{comment.comment}</span>
              </p>)
              })}
            </div>
            <div className="card-footer" style={{borderTop:"1px solid rgb(148 165 86)",borderTop:"1px solid rgb(148 165 86) "}}>
